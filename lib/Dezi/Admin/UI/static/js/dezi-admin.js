        ...
        series: [
          {
            ...
            tips: {
                ...
                renderer: function(storeItem, item) {
                    this.setTitle('search_time ('+storeItem.get('search_time')+ ') '+storeItem.get('total') + ' hits for ' + storeItem.get('q'));
                }
            },
            style: {
                'stroke-width': 0,
          ...
          }, 
          {
            ...
            tips: {
                ...
                height: 40,
                renderer: function(storeItem, item) {
                    this.setTitle('build_time ('+storeItem.get('build_time')+ ') '+storeItem.get('total') + ' hits for ' + storeItem.get('q'));
                }
            },
            style: {
                'stroke-width': 0,
